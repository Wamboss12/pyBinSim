    ...
    for speaker in speakers:
        ...
        for position in positions:
            ...
            for angle in range(90):
                ...
                # samples x channels
                sf.write(f'example/brirs/BRIR_{speaker}_{room}/{position}/brir' + str(angle * 4) + '.wav', brir.T, 48000)
                sf.write(f'example/brirs/BRIR_{speaker}_{room}_HP1/{position}/brir'+str(angle*4)+'.wav', brir_neu_1.T, 48000)
                sf.write(f'example/brirs/BRIR_{speaker}_{room}_HP2/{position}/brir' + str(angle * 4) + '.wav', brir_neu_2.T, 48000)
                sf.write(f'example/brirs/BRIR_{speaker}_{room}_HP3/{position}/brir' + str(angle * 4) + '.wav', brir_neu_3.T, 48000)
